...
const PERF_METRICS = {
  all: {
    ...
    clientRetention: 72,
    disputeRate: 4.2,
    avgTimeToEngage: "2.1d",
    avgBidsPerIntent: 3.4,
    engagementRate: 31,
  },
  SEO: {
    milestoneSuccess: 74,
    clientRetention: 78,
    disputeRate: 3.1,
    avgTimeToEngage: "1.8d",
    avgBidsPerIntent: 3.8,
    engagementRate: 35,
  },
  AIO: {
    milestoneSuccess: 61,
    clientRetention: 64,
    disputeRate: 5.8,
    avgTimeToEngage: "2.6d",
    avgBidsPerIntent: 2.9,
    engagementRate: 26,
  },
};
...
const MOCK_AGENTS = [
  {
    ...
    version: "2.4.1",
    verified: true,
    signedAt: "2025-02-18T09:14:00Z",
    status: "live",
    verticals: ["SEO"],
    description:
      "Full-stack SEO agent specializing in technical audits, on-page optimization, and ranking milestone delivery. Operates autonomously across crawl, analyze, and implement phases.",
    capabilities: [
    ...
    inputSchema: {
      fields: ["target_url", "keywords[]", "competitor_urls[]", "geo_target", "budget_cap"],
      version: "1.2",
    },
    outputSchema: {
      fields: ["audit_report", "ranking_changes[]", "backlinks_acquired[]", "lighthouse_scores", "action_log"],
      version: "1.2",
    },
    ...
    sla: {
      ...
      latencyP99: "12s",
      maxCost: "$280/run",
      retryPolicy: "3x exp backoff, 30s base",
      supportWindow: "24/7 auto, 8h human",
      uptime: "99.7%",
    },
    policy: {
      disallowed: ["PII collection", "Cloaking", "Link spam", "Scraping w/o attribution"],
  ...
  },
  {
    ...
    version: "3.1.0",
    verified: true,
    signedAt: "2025-02-20T11:30:00Z",
    status: "live",
    verticals: ["AIO"],
    description:
      "AIO-native agent purpose-built for Google AI Overview visibility. Restructures content, implements schema markup, and monitors AI citation status across target queries.",
    capabilities: [
    ...
    inputSchema: {
      fields: ["target_queries[]", "content_urls[]", "competitor_aio_analysis", "citation_goals", "budget_cap"],
      version: "2.0",
    },
    outputSchema: {
      fields: ["restructured_content[]", "schema_deployments[]", "aio_appearances[]", "citation_report", "entity_map"],
      version: "2.0",
    },
    ...
    sla: {
      ...
      latencyP99: "22s",
      maxCost: "$340/run",
      retryPolicy: "2x exp backoff, 60s base",
      supportWindow: "Biz hours + 4h emergency",
      uptime: "99.4%",
    },
    policy: {
      disallowed: ["Hallucinated citations", "Schema spam", "Content duplication", "Competitor defamation"],
      dataRetention: "45d encrypted at rest",
      sandbox: "Read-only CMS, write via approval queue",
    },
    evalClaims: [
  ...
  },
  {
    ...
    version: "1.8.3",
    verified: true,
    signedAt: "2025-02-15T14:22:00Z",
    status: "live",
    verticals: ["SEO"],
    description:
      "Specialized link building agent combining prospecting, outreach, and placement verification in a single autonomous pipeline with human-in-the-loop approval gates.",
    capabilities: [
    ...
    inputSchema: {
      fields: ["target_domain", "niche_keywords[]", "competitor_domains[]", "outreach_budget", "approval_webhook"],
      version: "1.0",
    },
    outputSchema: {
      fields: ["prospects[]", "outreach_log[]", "placements[]", "authority_delta", "cost_breakdown"],
      version: "1.0",
    },
    ...
    sla: {
      ...
      latencyP99: "28s",
      maxCost: "$450/run",
      retryPolicy: "3x exp backoff, 45s base",
      supportWindow: "24/7 auto",
      uptime: "99.2%",
    },
    policy: {
      disallowed: ["PBN links", "Paid link schemes", "Spam anchor text", "Auto-email w/o approval"],
      dataRetention: "30d encrypted",
      sandbox: "Outbound email rate-limited, domain allowlist",
    },
    evalClaims: [
  ...
  },
  {
    ...
    verticals: ["SEO"],
    description:
      "SEO agent in marketplace evaluation. Combines technical crawling with SERP position monitoring and mobile-first indexing optimization.",
    capabilities: [
    ...
    outputSchema: {
      fields: ["serp_report", "ranking_changes[]", "content_drafts[]", "performance_score"],
      version: "0.9",
    },
    ...
    sla: {
      ...
      latencyP99: "35s",
      maxCost: "$200/run",
      retryPolicy: "2x linear, 45s base",
      supportWindow: "Biz hours only",
      uptime: "97.8%",
    },
    policy: {
      disallowed: ["Content spinning", "Keyword stuffing", "Cloaking"],
      dataRetention: "14d",
      sandbox: "Standard hosted sandbox",
    },
    evalClaims: [
  ...
  },
  {
    ...
    version: "1.5.2",
    verified: true,
    signedAt: "2025-02-19T08:45:00Z",
    status: "live",
    verticals: ["AIO"],
    description:
      "Content-first AIO agent generating structured, citation-optimized content blocks. Converts existing pages into AIO-ready formats with entity linking and structured data.",
    capabilities: [
    ...
    inputSchema: {
      fields: ["content_urls[]", "target_entities[]", "schema_preferences", "citation_targets[]", "budget_cap"],
      version: "1.4",
    },
    outputSchema: {
      fields: ["optimized_pages[]", "schema_blocks[]", "entity_map", "citation_score", "structured_data_report"],
      version: "1.4",
    },
    ...
    sla: {
      ...
      latencyP99: "18s",
      maxCost: "$260/run",
      retryPolicy: "3x exp backoff, 20s base",
      supportWindow: "24/7 auto",
      uptime: "99.5%",
    },
    policy: {
      disallowed: ["Hallucinated entities", "Schema manipulation", "Copyright infringement"],
      dataRetention: "30d encrypted",
      sandbox: "Read-only source, write to staging",
    },
    evalClaims: [
  ...
  },
  {
    ...
    version: "4.0.1",
    verified: true,
    signedAt: "2025-02-22T16:08:00Z",
    status: "live",
    verticals: ["SEO", "AIO"],
    description:
      "Enterprise-grade technical SEO agent with AIO schema capabilities. Handles large-scale crawls (100K+ pages), Core Web Vitals remediation, structured data for AI Overviews, and programmatic SEO at scale with CI/CD integration.",
    capabilities: [
    ...
    inputSchema: {
      fields: ["target_domain", "crawl_config", "priority_pages[]", "cwv_targets", "ci_cd_webhook", "budget_cap"],
      version: "3.0",
    },
    outputSchema: {
      fields: ["crawl_report", "cwv_analysis", "fixes_deployed[]", "sitemap_status", "index_coverage", "perf_delta"],
      version: "3.0",
    },
    toolRequirements: [
      "web_crawler_enterprise",
      "lighthouse_api",
      "search_console_api",
      "ci_cd_hook",
      "cdn_purge",
    ...
    sla: {
      ...
      latencyP99: "14s",
      maxCost: "$800/run",
      retryPolicy: "3x exp backoff, checkpoint resume",
      supportWindow: "Dedicated TAM, 2h response",
      uptime: "99.8%",
    },
    policy: {
      disallowed: ["Prod deploy w/o staging", "Schema changes w/o backup", "Crawl rate > site capacity"],
      dataRetention: "90d encrypted",
      sandbox: "CI/CD gated, staging-first, rollback-safe",
    },
    evalClaims: [
...
const SCAN_PHASES = [
  {
    ...
    lines: (img) => [
      `$ docker pull ${img}`,
      `Resolving ${img.split("/")[0]}...`,
      `Pulling layers: ████████████████████ 100%`,
      `Digest: sha256:${Array.from({ length: 12 }, () => Math.floor(Math.random() * 16).toString(16)).join("")}...`,
      `Image size: ${(180 + Math.random() * 120).toFixed(0)}MB`,
  ...
  },
  {
    ...
    lines: (img) => [
      `$ docker inspect --format '{{json .Config}}' ${img.split(":")[0].split("/").pop()}`,
      `Entrypoint: ["python", "agent/main.py"]`,
      `WorkDir: /app`,
      `Env: AGENT_MODE=hosted, TELEMETRY=enabled`,
      `ExposedPorts: 8080/tcp, 9090/tcp (metrics)`,
      `Labels: com.agenticproxies.version, com.agenticproxies.verticals`,
      `Found: manifest.yaml at /app/manifest.yaml`,
    ],
  },
  {
    id: "manifest",
    label: "Parsing manifest",
    lines: () => [
      `Parsing /app/manifest.yaml...`,
      `├── name: detected`,
      `├── version: detected`,
      `├── verticals: detected`,
  ...
  },
  {
    ...
    lines: () => [
      `Static analysis: scanning /app/agent/**/*.py`,
      `AST parse: 14 modules, 38 functions, 12 tool calls`,
      `Capability inference from decorated handlers:`,
    ],
  },
  {
    id: "schemas",
    label: "Inferring I/O schemas",
    lines: () => [
      `Type analysis: inspecting function signatures + pydantic models`,
      `Input schema inferred from JobSpec handler:`,
      `Output schema inferred from RunResult builder:`,
      `JobSpec ↔ RunResult conformance: ✓ valid`,
    ],
  },
  {
    id: "tools",
    label: "Detecting tool dependencies",
    lines: () => [`Scanning imports, requirements.txt, tool invocation patterns...`, `Tool proxy calls detected:`],
  },
  {
    id: "sla",
    label: "Benchmarking SLA",
    lines: () => [`Running 50 warm-up + 200 benchmark iterations...`, `Latency profiling complete:`],
  },
  {
    id: "policy",
    label: "Policy compliance scan",
    lines: () => [
      `Scanning for disallowed patterns...`,
      `Network egress + data handling audit:`,
      `Declared disallowed actions:`,
    ],
  },
  {
    id: "eval",
    label: "Extracting eval claims",
    lines: () => [`Parsing evaluation_claims from manifest...`, `Cross-referencing with benchmark results...`],
  },
  {
    id: "wrap",
    label: "Wrapping agent",
    lines: () => [
      `Generating Supply Agent Wrapper...`,
      `├── Format Translation: injected`,
      `├── Budget Enforcement: configured`,
      `├── Tool Allowlist proxy: configured`,
      `├── Telemetry: connected`,
      `├── Checkpointing: enabled`,
      `└── Artifact Schema: enabled`,
      `Wrapper: ✓ complete`,
      `Sandbox worker provisioned: worker-${Math.random().toString(36).slice(2, 8)}`,
    ],
  },
];
...
const MOCK_INTENTS = [
  {
    ...
    vertical: "AIO",
    status: "bidding",
    queries: "skincare brand not in AI results",
    url: "bloombotanicals.com",
    bids: 4,
    created: "2025-02-20",
    budget: "$2,400/mo",
  },
  {
    id: "INT-002",
    business: "FastTrack Logistics",
    vertical: "SEO",
    status: "engaged",
    queries: "delivery service invisible on Google",
    url: "fasttracklogistics.com",
    bids: 3,
    created: "2025-02-18",
    budget: "$1,800/mo",
    agent: "TechSEO Pro",
  },
  {
    ...
    vertical: "AIO",
    status: "bidding",
    queries: "wellness app lost to AI overview competitors",
    url: "mindfulapp.io",
    bids: 2,
    created: "2025-02-21",
    budget: "$1,200/mo",
  ...
  {
    id: "INT-004",
    business: "ClearView Solar",
    vertical: "AIO",
    status: "milestone",
    queries: "solar installer needs AI search visibility",
    url: "clearviewsolar.co",
    bids: 5,
    created: "2025-02-12",
    budget: "$3,600/mo",
    agent: "RankForge",
    milestone: "AIO appearance confirmed for 2/5 target queries",
  },
  {
    id: "INT-005",
    business: "PetPals Vet",
    vertical: "AIO",
    status: "completed",
    queries: "vet clinic missing from AI answers",
    url: "petpalsvet.com",
    bids: 3,
    created: "2025-01-28",
    budget: "$900/mo",
  ...
  {
    id: "INT-006",
    business: "NovaBrew Coffee",
    vertical: "SEO",
    status: "bidding",
    queries: "coffee brand not ranking for subscriptions",
    url: "novabrew.com",
    bids: 1,
    created: "2025-02-22",
    budget: "$1,500/mo",
  ...
  SEO: [
    {
      ...
      desc: "Full site audit, Core Web Vitals, crawlability",
      timeline: "4 wk",
    ...
    },
    {
      ...
      desc: "Target keywords into top 10 positions",
      timeline: "8–12 wk",
      metric: "≥5 in top 10",
    },
    {
      id: "seo-3",
      name: "Revenue Share",
      desc: "% of incremental organic revenue",
      timeline: "Ongoing",
  ...
  AIO: [
    {
      ...
      desc: "Rewrite for AI-friendly extraction",
      timeline: "3–6 wk",
      metric: "AIO readiness ✓",
    },
    {
      id: "aio-2",
      name: "Structured Data",
      desc: "Schema markup for target pages",
      timeline: "2–4 wk",
      metric: "100% valid schema",
    },
    {
      id: "aio-3",
      name: "AIO Appearance",
      desc: "Appear in AI Overviews for target queries",
      timeline: "8–16 wk",
      metric: "≥3 queries",
    },
  ],
...
const INTENT_MARKET = [
  {
    id: 1,
    query: "my skincare brand doesn't show in AI answers",
    vol: 74000,
    volTrend: [31, 38, 42, 51, 58, 67, 74],
    aioRate: 82,
    ctr: 12,
    ctrDelta: -28,
    competition: 87,
  ...
  {
    id: 2,
    query: "delivery company not ranking locally",
    vol: 165000,
    volTrend: [90, 102, 118, 130, 142, 155, 165],
    aioRate: 71,
    ctr: 18,
    ctrDelta: -22,
    competition: 93,
  ...
  {
    id: 3,
    query: "solar installer needs AI overview placement",
    vol: 52000,
    volTrend: [22, 28, 31, 36, 40, 47, 52],
    aioRate: 94,
    ctr: 8,
    ctrDelta: -41,
    competition: 62,
  ...
  {
    id: 4,
    query: "health app losing traffic to AI summaries",
    vol: 41000,
    volTrend: [18, 22, 25, 29, 34, 38, 41],
    aioRate: 88,
    ctr: 14,
    ctrDelta: -31,
    competition: 71,
  ...
  {
    id: 5,
    query: "coffee subscription brand invisible on Google",
    vol: 33000,
    volTrend: [15, 18, 21, 24, 27, 30, 33],
    aioRate: 45,
    ctr: 32,
    ctrDelta: -8,
    competition: 78,
  ...
  {
    id: 6,
    query: "veterinary clinic missing from emergency search",
    vol: 128000,
    volTrend: [70, 82, 90, 98, 108, 118, 128],
    aioRate: 76,
    ctr: 22,
    ctrDelta: -19,
    competition: 55,
  ...
  {
    id: 7,
    query: "SaaS startup needs to rank for CRM searches",
    vol: 89000,
    volTrend: [45, 52, 60, 68, 74, 82, 89],
    aioRate: 91,
    ctr: 10,
    ctrDelta: -35,
    competition: 96,
  ...
  {
    id: 8,
    query: "energy company wants AI overview citations",
    vol: 97000,
    volTrend: [40, 48, 55, 64, 75, 86, 97],
    aioRate: 86,
    ctr: 11,
    ctrDelta: -33,
    competition: 44,
  ...
  {
    id: 9,
    query: "marketing agency can't rank its own site",
    vol: 28000,
    volTrend: [12, 15, 17, 20, 22, 25, 28],
    aioRate: 38,
    ctr: 36,
    ctrDelta: -5,
    competition: 82,
  ...
  {
    id: 10,
    query: "AI writing tool buried by competitor overviews",
    vol: 112000,
    volTrend: [30, 42, 55, 70, 85, 98, 112],
    aioRate: 93,
    ctr: 9,
    ctrDelta: -38,
    competition: 89,
  ...
  {
    id: 11,
    query: "restaurant needs POS system review visibility",
    vol: 47000,
    volTrend: [25, 28, 32, 36, 39, 43, 47],
    aioRate: 79,
    ctr: 15,
    ctrDelta: -24,
    competition: 68,
  ...
  {
    id: 12,
    query: "law firm losing leads to competitors on search",
    vol: 210000,
    volTrend: [150, 162, 170, 182, 192, 200, 210],
    aioRate: 64,
    ctr: 25,
    ctrDelta: -14,
    competition: 98,
...
const LIVE_SIGNALS = [
  {
    id: "SIG-001",
    query: "skincare brand not in AI answers",
    vertical: "AIO",
    status: "live",
    rank: 2,
    prevRank: 4,
    ...
    aioVisible: true,
    lastUpdate: "12s ago",
    spend7d: [1200, 1400, 1600, 1750, 1800, 1820, 1840],
    category: "Beauty & Wellness",
    signal: 94,
  },
  {
    ...
    aioVisible: true,
    lastUpdate: "4s ago",
    spend7d: [2800, 2900, 3000, 3050, 3100, 3150, 3200],
    category: "Logistics & Transport",
    signal: 98,
  },
  {
    ...
    aioVisible: true,
    lastUpdate: "28s ago",
    spend7d: [600, 680, 750, 820, 880, 940, 980],
    category: "Home Services",
    signal: 87,
  },
  {
    ...
    aioVisible: true,
    lastUpdate: "8s ago",
    spend7d: [700, 800, 850, 920, 980, 1050, 1100],
    category: "Health & Fitness",
    signal: 82,
  },
  {
    id: "SIG-005",
    query: "coffee brand invisible on Google",
    vertical: "SEO",
    status: "live",
    rank: 7,
    prevRank: 6,
    ...
    aioVisible: false,
    lastUpdate: "45s ago",
    spend7d: [500, 540, 580, 620, 660, 690, 720],
    category: "Food & Beverage",
    signal: 61,
  },
  {
    id: "SIG-006",
    query: "vet clinic missing from emergency search",
    vertical: "AIO",
    status: "live",
    rank: 2,
    prevRank: 3,
    ...
    aioVisible: true,
    lastUpdate: "2s ago",
    spend7d: [2000, 2100, 2250, 2350, 2450, 2520, 2600],
    category: "Pet Services",
    signal: 91,
  },
  {
    id: "SIG-007",
    query: "SaaS startup needs CRM search ranking",
    vertical: "AIO",
    status: "live",
    rank: 4,
    prevRank: 4,
    ...
    aioVisible: true,
    lastUpdate: "16s ago",
    spend7d: [1600, 1700, 1800, 1880, 1950, 2030, 2100],
    category: "SaaS & Tech",
    signal: 89,
  },
  {
    ...
    aioVisible: true,
    lastUpdate: "1m ago",
    spend7d: [400, 480, 560, 640, 720, 790, 860],
    category: "Home Services",
    signal: 85,
  },
  {
    ...
    aioVisible: true,
    lastUpdate: "6s ago",
    spend7d: [1800, 2000, 2200, 2400, 2550, 2700, 2850],
    category: "SaaS & Tech",
    signal: 96,
  },
  {
    id: "SIG-010",
    query: "law firm losing leads to competitors",
    vertical: "SEO",
    status: "live",
    rank: 1,
    prevRank: 1,
    ...
    aioVisible: false,
    lastUpdate: "1s ago",
    spend7d: [4200, 4350, 4450, 4550, 4650, 4720, 4800],
    category: "Legal",
    signal: 99,
  },
  {
    id: "SIG-011",
    query: "restaurant needs POS review visibility",
    vertical: "SEO",
    status: "warming",
    rank: 8,
    prevRank: 11,
    ...
    aioVisible: true,
    lastUpdate: "2m ago",
    spend7d: [320, 380, 440, 500, 550, 590, 640],
    category: "Food & Beverage",
    signal: 72,
  },
  {
    id: "SIG-012",
    query: "marketing agency can't rank own site",
    vertical: "SEO",
    status: "cooling",
    rank: 12,
    prevRank: 10,
    ...
    aioVisible: false,
    lastUpdate: "5m ago",
    spend7d: [520, 500, 480, 460, 430, 400, 380],
    category: "Professional Services",
    signal: 41,
  },
];
      ...
      <div>
        ...
        >
          {[
            ...
            {
              l: "Competition",
              v: `${detailIntent.competition}/100`,
              sub: "difficulty score",
              c: detailIntent.competition >= 85 ? "#EF5350" : detailIntent.competition >= 65 ? "#FFA726" : "#66BB6A",
            },
            {
              l: "Opp Score",
              v: detailIntent.opportunity,
              sub: "composite ranking",
              c: detailIntent.opportunity >= 80 ? "#66BB6A" : "#FFA726",
            },
          ].map((k, i) => (
            <div
              key={i}
