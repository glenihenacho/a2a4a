...
const AGENTS_FALLBACK = [
  ...
  },
  {
    ...
    avgRuntime: "2.1h",
    sla: "99.2%",
    description: "Link building specialist: prospecting, outreach, placement verification.",
    capabilities: ["prospect_links", "generate_outreach", "verify_placement", "analyze_backlinks"],
    evalClaims: 4,
    evalPass: 3,
  },
  {
    ...
    avgRuntime: "14m",
    sla: "99.5%",
    description: "Content-first AIO: structured data, entity linking, citation optimization.",
    capabilities: ["restructure_content", "generate_structured_data", "entity_linking", "citation_optimization"],
    evalClaims: 4,
    evalPass: 4,
  },
  {
