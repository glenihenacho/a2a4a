...
const MOCK_AGENTS = [
  {
    ...
    capabilities: [
      { name: "crawl_site", domain: "SEO", description: "Deep site crawl with Core Web Vitals and crawlability analysis", triggers: ["technical-seo", "site-audit", "crawl"], tags: ["crawl", "cwv", "lighthouse"] },
      { name: "audit_technical", domain: "SEO", description: "Lighthouse-driven audit with prioritized fix recommendations", triggers: ["technical-audit", "lighthouse", "performance"], tags: ["audit", "lighthouse", "cwv"] },
      { name: "optimize_onpage", domain: "SEO", description: "Title, meta, heading, and content structure optimization", triggers: ["on-page", "meta-tags", "content-optimization"], tags: ["onpage", "meta", "headings"] },
      { name: "build_links", domain: "SEO", description: "Outreach-based backlink acquisition with relevance scoring", triggers: ["link-building", "backlinks", "outreach"], tags: ["links", "outreach", "authority"] },
      { name: "track_rankings", domain: "SEO", description: "SERP position monitoring with keyword cluster analysis", triggers: ["rank-tracking", "serp-monitoring", "keywords"], tags: ["rankings", "serp", "keywords"] },
    ],
  ...
  },
  {
    ...
    capabilities: [
      { name: "restructure_content", domain: "AIO", description: "Rewrite content for AI-friendly extraction and citation", triggers: ["content-restructuring", "ai-optimization", "citation"], tags: ["content", "ai-friendly", "citation"] },
      { name: "implement_schema", domain: "AIO", description: "Deploy FAQ, HowTo, and custom schema markup", triggers: ["schema-markup", "structured-data", "faq"], tags: ["schema", "jsonld", "markup"] },
      { name: "monitor_aio", domain: "AIO", description: "Track AI Overview appearances and citation status", triggers: ["aio-monitoring", "citation-tracking", "visibility"], tags: ["monitoring", "aio", "citations"] },
      { name: "generate_faq", domain: "AIO", description: "Auto-generate structured FAQ blocks from content", triggers: ["faq-generation", "structured-content", "questions"], tags: ["faq", "generation", "structured"] },
      { name: "optimize_entities", domain: "AIO", description: "Entity resolution and knowledge graph alignment", triggers: ["entity-resolution", "knowledge-graph", "entities"], tags: ["entities", "knowledge-graph", "nlp"] },
    ],
  ...
  },
  {
    ...
    capabilities: [
      { name: "prospect_links", domain: "SEO", description: "Identify high-authority link targets via relevance scoring", triggers: ["link-prospecting", "authority-targets", "outreach"], tags: ["prospecting", "authority", "targets"] },
      { name: "generate_outreach", domain: "SEO", description: "Personalized outreach email generation and sequencing", triggers: ["outreach-email", "link-outreach", "personalization"], tags: ["outreach", "email", "sequencing"] },
      { name: "verify_placement", domain: "SEO", description: "Confirm link placement, anchor text, and follow status", triggers: ["link-verification", "placement-check", "anchor-text"], tags: ["verification", "placement", "anchors"] },
      { name: "analyze_backlinks", domain: "SEO", description: "Competitor backlink profile gap analysis", triggers: ["backlink-analysis", "competitor-links", "gap-analysis"], tags: ["backlinks", "competitors", "analysis"] },
    ],
  ...
  },
  {
    ...
    capabilities: [
      { name: "crawl_site", domain: "SEO", description: "Technical crawl with mobile-first indexing checks", triggers: ["mobile-first", "crawl", "indexing"], tags: ["crawl", "mobile", "indexing"] },
      { name: "track_rankings", domain: "SEO", description: "Daily SERP tracking with competitor comparison", triggers: ["rank-tracking", "serp-monitoring", "competitor-tracking"], tags: ["rankings", "serp", "daily"] },
      { name: "generate_content", domain: "SEO", description: "SEO-optimized content drafts from keyword clusters", triggers: ["content-generation", "keyword-content", "seo-writing"], tags: ["content", "keywords", "drafts"] },
    ],
  ...
  },
  {
    ...
    capabilities: [
      { name: "restructure_content", domain: "AIO", description: "Transform pages into AI-extractable format", triggers: ["content-restructuring", "ai-extraction", "page-optimization"], tags: ["content", "restructuring", "ai-ready"] },
      { name: "generate_structured_data", domain: "AIO", description: "Auto-generate JSON-LD schema from content", triggers: ["structured-data", "json-ld", "schema-generation"], tags: ["jsonld", "schema", "structured"] },
      { name: "entity_linking", domain: "AIO", description: "Map content entities to knowledge graph nodes", triggers: ["entity-linking", "knowledge-graph", "entity-mapping"], tags: ["entities", "knowledge-graph", "linking"] },
      { name: "citation_optimization", domain: "AIO", description: "Optimize content for AI citation probability", triggers: ["citation-optimization", "ai-citation", "visibility"], tags: ["citations", "optimization", "probability"] },
    ],
  ...
  },
  {
    ...
    capabilities: [
      { name: "crawl_site", domain: "SEO", description: "Enterprise crawl engine, 100K+ pages, JS rendering", triggers: ["enterprise-crawl", "large-scale", "js-rendering"], tags: ["crawl", "enterprise", "javascript"] },
      { name: "audit_technical", domain: "SEO", description: "CWV deep-dive, server config, redirect chain analysis", triggers: ["cwv-audit", "server-config", "redirect-analysis"], tags: ["cwv", "audit", "redirects"] },
      { name: "generate_sitemaps", domain: "SEO", description: "Dynamic XML sitemap generation and submission", triggers: ["sitemap-generation", "xml-sitemap", "indexing"], tags: ["sitemaps", "xml", "indexing"] },
      { name: "optimize_onpage", domain: "SEO", description: "Programmatic title/meta optimization at scale", triggers: ["programmatic-seo", "title-optimization", "meta-tags"], tags: ["onpage", "programmatic", "scale"] },
      { name: "implement_schema", domain: "AIO", description: "Deploy structured data for AI Overview citation", triggers: ["schema-markup", "structured-data", "aio-citation"], tags: ["schema", "structured-data", "aio"] },
      { name: "monitor_indexing", domain: "SEO", description: "Search Console integration for index coverage", triggers: ["index-monitoring", "search-console", "coverage"], tags: ["indexing", "search-console", "monitoring"] },
    ],
